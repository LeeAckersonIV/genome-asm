...
#SBATCH --qos=agil-mem
#SBATCH --chdir=/project/ruminant_t2t/Pig/assembly/raft_hifiasmUL-scaff
...
hifiasm -o pig_raft_trioUL -t 96 -r 1 -1 pat.yak -2 mat.yak --ul Pig_ULONT.fastq.gz --dual-scaf fragmented.reads.fasta 2> finalasm.log
