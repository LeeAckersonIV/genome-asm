...
# Disclaimer: This is a small portion of a larger workflow, and varies case by
## case, so there may be parts that are not relevant to your process.
###############################################################################
...
mkdir verkko2.2_hifi-duplex_trio.patch1 && cd verkko2.2_hifi-duplex_trio.patch1
...
# copy in necessary inputs
# =============================================================================
# Set up parent diretory for verkko_final_asm folder
cd /90daydata/ruminant_t2t/Pig/assembly
mkdir relaunch.patch1.verkko2.2_hifi-duplex_trio && cd relaunch.patch1.verkko2.2_hifi-duplex_trio
